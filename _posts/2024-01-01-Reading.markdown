...
* [OpenAI Clip](https://arxiv.org/abs/2103.00020): Traditionally, computer vision models need labeled data to recognize new objects, limiting their adaptability. Training models to describe images with text captions allows them to understand and tackle new tasks without additional task-specific data, making them highly versatile.
